    ...
    <div className="contact-container">
      ...
      <div className="container">
        <section className="m-3">
          ...
          <h4 className="text-center w-responsive mx-4 mb-3">Welcome to our Food Delivery Application! We are passionate about bringing delicious meals right to your doorstep. With our wide selection of cuisines and restaurants, we strive to provide a convenient and enjoyable dining experience for our customers. 
